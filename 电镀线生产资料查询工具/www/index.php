...
<script>
    ...
    */
    ...
    // alert(md5(md5('')));
    // 都是极其简单的密码或奇异密码
    // 123 ,三个空格，1,0,5623,000
    var passwdmd5 = ['d9b1d7db4cd6e70935368a1efb10e377', 'c53e45a6eb973bad1cb842e6ddd648d0', 'd2e659c75637d8a4ab53b2d4a9df83cf', 'b900afac6b173100b1e55432e9d58c88', '3049a1fof1c808cdaa4fbed0e01649b1', '28c8edde3d61a0411511d3b1866f0636', 'dcfcd07e645d245babe887e5e2daa016', ];
    ...
    <div class="left">
        ...
        <select name="lineSelect" id="lineSelect">';
            if (!empty($_COOKIE['line']) && $_COOKIE['line'] == 'line0') {
                echo '<option value="line0" title="显示相应线体" selected>Line 0 全部</a></option>';
            } else {
                echo '<option value="line0" title="显示相应线体">Line 0 全部</a></option>';
            }
        ...
        <ul>
            ...
            <li><a href="javascript:setCookies([['lang', 'zh']]);" id="idzh" title="切换到中文(简体)显示">~中文显示(实验性)</a></li>
        </ul>
