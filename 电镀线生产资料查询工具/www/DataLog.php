...
switch ($_COOKIE['type']) {
    ...
    case 'L4Voltage':
        ...
        break;
    case 'Temperatures':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_Temperature, $DataLog_L2_Temperature, $DataLog_L3_Temperature, $DataLog_L4_Temperature);
        } else {
            for ($i = 1; $i < 5; $i++) {
    ...
    case 'Current':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            include(dirname(__DIR__) . '/www/tbheader/L3/DataLog_L3_Current.php');
            include(dirname(__DIR__) . '/www/tbheader/L4/DataLog_L4_Current.php');
            $tbheader = array_merge($DataLog_L1_Current, $DataLog_L2_Current, $DataLog_L3_Current, $DataLog_L4_Current);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'Voltage':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            include(dirname(__DIR__) . '/www/tbheader/L3/DataLog_L3_Voltage.php');
            include(dirname(__DIR__) . '/www/tbheader/L4/DataLog_L4_Voltage.php');
            $tbheader = array_merge($DataLog_L1_Voltage, $DataLog_L2_Voltage, $DataLog_L3_Voltage, $DataLog_L4_Voltage);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'Speed':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            include(dirname(__DIR__) . '/www/tbheader/L3/DataLog_L3_Speed.php');
            include(dirname(__DIR__) . '/www/tbheader/L4/DataLog_L4_Speed.php');
            $tbheader = array_merge($DataLog_L1_Speed, $DataLog_L2_Speed, $DataLog_L3_Speed, $DataLog_L4_Speed);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'FlowRate':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_FlowRate, $DataLog_L2_FlowRate, $DataLog_L3_FlowRate, $DataLog_L4_FlowRate);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'Conductivity':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_Conductivity, $DataLog_L2_Conductivity, $DataLog_L3_Conductivity, $DataLog_L4_Conductivity);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'Pressure':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_Pressure, $DataLog_L2_Pressure, $DataLog_L3_Pressure, $DataLog_L4_Pressure);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'AmpMin':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_AmpMin, $DataLog_L2_AmpMin, $DataLog_L3_AmpMin, $DataLog_L4_AmpMin);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'OnOffPumpSpeed':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_OnOffPumpSpeed, $DataLog_L2_OnOffPumpSpeed, $DataLog_L3_OnOffPumpSpeed, $DataLog_L4_OnOffPumpSpeed);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    case 'other':
        if (!isset($_COOKIE['line']) || $_COOKIE['line'] == 'line0') {
            ...
            $tbheader = array_merge($DataLog_L1_other, $DataLog_L2_other, $DataLog_L3_other, $DataLog_L4_other);
        } else {
            for ($i = 1; $i < 5; $i++) {
                if ($_COOKIE['line'] == 'line' . $i) {
    ...
    default:
        ...
        $tbheader = array_merge($DataLog_L1_default, $DataLog_L2_default, $DataLog_L3_default, $DataLog_L4_default);
        break;
}
// 去重复
